...
def init_sqlite_db():
    ...
    # Seed real Shivapura data if the database table is empty
    ...
    if cursor.fetchone()[0] == 0:
        ...
        cursor.executemany("INSERT INTO VillagePlaces (category, place_name, timings, description) VALUES (?, ?, ?, ?)", [
            ...
            ('Hospital', 'Primary Health Sub-Center (ಆರೋಗ್ಯ ಕೇಂದ್ರ)', '09:00 AM - 01:00 PM', 'Basic healthcare, emergencies, and free government medical drops.'),
